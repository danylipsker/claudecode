...
if __name__ == "__main__":
    ...
    from compound_planetary import CompoundPlanetaryParams, build_compound_planetary_set
    compound = CompoundPlanetaryParams(face_width_mm=6.0, face_width_2_mm=6.0, step_gap_mm=2.0)
    c_sun, c_planets, c_ring_2, c_ring_1 = build_compound_planetary_set(compound, simplify_tolerance_mm=0.05)
    render_solid_thumbnail(bd.Compound(children=[c_sun, *c_planets, c_ring_2, c_ring_1]),
                           f"{out_dir}/thumb_compound_planetary.png", elev=35, azim=-50)
