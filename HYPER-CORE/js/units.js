...
(function (root) {
  ...
  const Q = {
    ...
    concentration: { name: 'concentration', units: [['mol/L', 1e3], ['M', 1e3], ['mM', 1], ['µM', 1e-3], ['nM', 1e-6], ['mol/m³', 1], ['mmol/L', 1]] },
    molality:    { name: 'molality', units: [['mol/kg', 1], ['mmol/kg', 1e-3]] },
    molarenergy: { name: 'molar energy', units: [['kJ/mol', 1e3], ['J/mol', 1], ['kcal/mol', 4184], ['eV/particle', 96485.33212]] },
    molarvolume: { name: 'molar volume', units: [['L/mol', 1e-3], ['m³/mol', 1], ['cm³/mol', 1e-6], ['mL/mol', 1e-6]] },
    reactionrate: { name: 'reaction rate', units: [['M/s', 1e3], ['mol/(L·s)', 1e3], ['mM/s', 1], ['µM/s', 1e-3], ['M/min', 1e3 / 60], ['mol/(m³·s)', 1]] },
    rateconst2: { name: 'second-order rate constant', units: [['1/(M·s)', 1e-3], ['L/(mol·s)', 1e-3], ['1/(M·min)', 1e-3 / 60], ['m³/(mol·s)', 1]] },
    molarabs: { name: 'molar absorptivity', units: [['L/(mol·cm)', 0.1], ['1/(M·cm)', 0.1], ['m²/mol', 1], ['cm²/mol', 1e-4]] },
    henry: { name: 'Henry\'s law constant', units: [['M/atm', 1e3 / 101325], ['mol/(L·atm)', 1e3 / 101325], ['M/bar', 1e-2], ['mol/(m³·Pa)', 1]] },
    colligative: { name: 'colligative constant', units: [['K·kg/mol', 1], ['°C·kg/mol', 1]] },
