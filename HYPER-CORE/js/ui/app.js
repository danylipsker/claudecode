...
(function () {
  ...
  const P = {
    ...
    resistor: '<path d="M1.5 12h4l1.6-4 2.8 8 2.8-8 2.8 8 1.6-4h5.4"/>',
    capacitor: '<path d="M2 12h8M14 12h8M10 5v14M14 5v14"/>',
    diode: '<path d="M2 12h6M16 12h6M16 6v12"/><path d="M8 6.5l8 5.5-8 5.5z"/>',
    transistor: '<circle cx="12" cy="12" r="9"/><path d="M3 12h6M9 7.5v9M9 10l6-4V3M9 14l6 4v3"/><path d="m15 18-3.2-.4 1.6-2.4z" fill="currentColor"/>',
    opamp: '<path d="M6 4v16l14-8z"/><path d="M2 9h4M2 15h4M20 12h3M8.5 9h2M8.5 15h2M9.5 14v2"/>',
    gate: '<path d="M5 5h6.5a7 7 0 0 1 0 14H5z"/><path d="M1.5 9H5M1.5 15H5M18.5 12h4"/>',
    sine: '<path d="M2 12h20" opacity=".35"/><path d="M2 12c2.3-7 4.7-7 7 0s4.7 7 7 0 3.5-5 6-2"/>',
    filter: '<path d="M3.5 3.5v17h17"/><path d="M5.5 8h7.5c2.6 0 4.6 4.5 6.5 10.5"/>',
    battery: '<rect x="2.5" y="7" width="17" height="10" rx="2"/><path d="M21.5 10.5v3M6 12h4M8 10v4M13 12h3"/>',
    antenna: '<path d="M12 21.5V9M12 9 7 3.5h10z"/><path d="M4.5 12a9 9 0 0 1 0-8M19.5 12a9 9 0 0 0 0-8" opacity=".7"/>',
    chip: '<rect x="6" y="6" width="12" height="12" rx="1.5"/><path d="M9 2.5V6M12 2.5V6M15 2.5V6M9 18v3.5M12 18v3.5M15 18v3.5M2.5 9H6M2.5 12H6M2.5 15H6M18 9h3.5M18 12h3.5M18 15h3.5"/>',
    meter: '<circle cx="12" cy="13" r="8.5"/><path d="M12 13l4.5-4.5M8 17.5h8"/>',
    flask: '<path d="M9.5 3h5M10 3v6.2L4.2 18.6A1.6 1.6 0 0 0 5.6 21h12.8a1.6 1.6 0 0 0 1.4-2.4L14 9.2V3"/><path d="M7 15h10"/>',
    beaker: '<path d="M4 3.5h15M5.5 3.5v15a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2v-15"/><path d="M5.5 12.5c2-1 4-1 6 0s4 1 6 0"/>',
    molecule: '<circle cx="12" cy="12" r="3"/><circle cx="4.5" cy="6" r="2"/><circle cx="19.5" cy="6" r="2"/><circle cx="12" cy="20.5" r="2"/><path d="m9.6 10.2-3.4-2.9M14.4 10.2l3.4-2.9M12 15v3.5"/>',
    benzene: '<path d="M12 2.8 20 7.4v9.2L12 21.2 4 16.6V7.4z"/><circle cx="12" cy="12" r="4.4"/>',
    table: '<rect x="2.5" y="4" width="4" height="4" rx=".6"/><rect x="17.5" y="4" width="4" height="4" rx=".6"/><rect x="2.5" y="9" width="4" height="4" rx=".6"/><rect x="7.5" y="9" width="4" height="4" rx=".6"/><rect x="12.5" y="9" width="4" height="4" rx=".6"/><rect x="17.5" y="9" width="4" height="4" rx=".6"/><rect x="2.5" y="14" width="4" height="4" rx=".6"/><rect x="7.5" y="14" width="4" height="4" rx=".6"/><rect x="12.5" y="14" width="4" height="4" rx=".6"/><rect x="17.5" y="14" width="4" height="4" rx=".6"/>',
    bond: '<circle cx="5.5" cy="12" r="3.3"/><circle cx="18.5" cy="12" r="3.3"/><path d="M8.8 10.4h6.4M8.8 13.6h6.4"/>',
    gas: '<circle cx="6" cy="7" r="1.6"/><circle cx="15" cy="5" r="1.6"/><circle cx="18" cy="14" r="1.6"/><circle cx="9" cy="17" r="1.6"/><circle cx="11" cy="11" r="1.6"/><path d="M7.4 7.8 9 9.4M16 6.5l1.2 2M19 15.6l1.2 2M7.8 18.5 6 20" opacity=".6"/>',
    scale: '<path d="M12 3.5v17M6 20.5h12M4 7h16"/><path d="M4 7 1.5 13a3 3 0 0 0 5 0zM20 7l-2.5 6a3 3 0 0 0 5 0z"/>',
    equilibrium: '<path d="M3 9h17l-4-3.5M21 15H4l4 3.5"/>',
